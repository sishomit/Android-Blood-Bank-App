...
import com.shomit.blood.activities.Sidemenu;
...
public class Achievments extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.donation_achievment, container, false);
            ...
            userQ.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot.exists())
                    {
                        ...
                        final int getdiv = userinfo.getDivision();
                        final int getbg = userinfo.getBloodGroup();
                        ...
                        donorQ.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                                if(dataSnapshot.exists())
                                {
                                    ...
                                    totalDonate.setText(donor.getTotalDonate()+" times");
                                    if(donor.getTotalDonate() == 0) {
                                        lastDate = "01/01/2001";
                                        lastDonate.setText("Do not donate yet!");
                                    }
                                    else {
                                        lastDate = donor.getLastDonate();
                                        lastDonate.setText(donor.getLastDonate());
                                    }
                                                ...
                                                yes.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        ...
                                                        db_ref.child(divisionlist[getdiv])
                                                                .child(bloodgroup[getbg])
                                                                .child(mAuth.getCurrentUser().getUid())
                                                                .child("TotalDonate").setValue(donor.getTotalDonate()+1);
