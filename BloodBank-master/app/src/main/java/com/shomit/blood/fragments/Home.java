...
import com.shomit.blood.adapters.Bloodrequestpost;
...
public class Home extends Fragment {
    ...
    FirebaseAuth mAuth;
    private Bloodrequestpost restAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        restAdapter = new Bloodrequestpost(postLists);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot singlepost : dataSnapshot.getChildren()) {
                        Profileset profileset = singlepost.getValue(Profileset.class);
                        postLists.add(profileset);
