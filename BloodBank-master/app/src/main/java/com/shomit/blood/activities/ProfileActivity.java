            ...
            Profile.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (userinfo != null) {
                        ...
                        gender.setSelection(userinfo.getGender());
                        address.setText(userinfo.getAddress());
                        contact.setText(userinfo.getContact());
                        bloodgroup.setSelection(userinfo.getBloodGroup());
                        division.setSelection(userinfo.getDivision());
                                            ...
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                ...
                                                if (!task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(getApplicationContext(), "Welcome, your account has been created!", Toast.LENGTH_LONG)
                                                            .show();
                                                    Intent intent = new Intent(ProfileActivity.this, Sidemenu.class);
