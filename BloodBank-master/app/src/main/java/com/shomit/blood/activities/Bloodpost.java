...
public class Bloodpost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.request_for_blood);
        ...
        if(cur_user == null)
        {
            startActivity(new Intent(Bloodpost.this, Login.class));
        } else {
            uid = cur_user.getUid();
        }
                        ...
                        findname.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    db_ref.child(uid).child("Name").setValue(dataSnapshot.getValue(Userinfo.class).getName());
                                    ...
                                    db_ref.child(uid).child("Details").setValue(text3.getText().toString());
                                    ...
                                    db_ref.child(uid).child("Quantity").setValue(spinner3.getSelectedItem().toString());
                                    db_ref.child(uid).child("Time").setValue(Time);
                                    db_ref.child(uid).child("Date").setValue(Date);
                                    Toast.makeText(Bloodpost.this, "Your post has been created successfully",
                                            Toast.LENGTH_LONG).show();
                                    startActivity(new Intent(Bloodpost.this, Sidemenu.class));
